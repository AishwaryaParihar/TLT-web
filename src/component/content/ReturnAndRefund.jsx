...
const ReturnAndRefund = () => {
  return (
    <div className="sm:m-20 sm:p-8 p-4 bg-white shadow-lg rounded-lg">
      ...
      <h1 className="font-bold text-2xl sm:pt-8 pt-6 text-shadow">Our refund policy is:</h1>
      <ul className="text-lg list-disc list-inside mt-4 space-y-4">
        ...
        <li>
          <span className="text-red-500 text-shadow">Note:</span> All refunds will be processed within 30 working days after the refund request is approved.
        </li>
      </ul>
      
      <h2 className="text-center font-bold text-4xl text-primary sm:pt-10 pt-8 text-shadow">Return Policy</h2>
      <h1 className="font-bold text-2xl sm:pt-6 pt-6 text-shadow">No refund after Delivery of the product:</h1>
