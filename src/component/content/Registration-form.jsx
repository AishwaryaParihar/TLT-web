...
//             <input type="file" name="choose-picture" id="choose-picture" className="border rounded w-full p-4"/>
//           </div>
//           <div className='flex'>
//             <label htmlFor="name" className="block text-left  font-bold text-lg">Name:</label>
//             <input type="text" name="name" id="name" placeholder="Enter your name" className="border rounded w-full p-2 ml-14 "/>
//           </div>
//           <div className='flex'>
...
//           </div>
//           <div className='flex'>
//             <label htmlFor="full-address" className="block text-left  font-bold text-lg ml-2">Full Address:</label>
...
//             <select id="state" className="border rounded w-full p-2 ml-14">
//               <option>1</option>
//               <option>2</option>
//               <option>3</option>
//               <option>4</option>
...
//             <input type="number" name="pin-code" id="pin-code" placeholder="Enter your pin code" className="border rounded w-full p-2 ml-8"/>
//           </div>
//           <div className='flex'>
...
const RegistrationForm = () => {
  ...
  <div className="flex justify-center mt-6">
            <button type='submit' className='bg-green-500 border border-black text-white font-bold py-2 px-4 rounded mb-10'>
              Submit
            </button>
          </div>
