    ...
    <div> <div className=" my-20">
      <div className="mx-5 md:mx-20">
        <div className="uppercase font-semibold  text-xs inline-block tracking-wider ">
          <Headings heading={'h6'} style={'text-shadow'}>WELCOME TO TLT JUDICIAL ACADEMY</Headings>
        ...
        <div className="flex gap-2 py-3">
          <Button onClick={handleClick} color="red"> get started now <i className="fa-solid fa-arrow-right"></i></Button>    <Button onClick={handleClick} color="white"> view course <i className="fa-solid fa-arrow-right"></i></Button>
        </div>
      </div>
    </div></div>
  )
