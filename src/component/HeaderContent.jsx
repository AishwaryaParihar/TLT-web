...
export const HeaderContent = () => {
  ...
  return (
    ...
    <div className="mx-5 md:mx-20">
      ...
      <Headings heading={'h1'} style={''}>
        Best <br /> Education Expertise
      </Headings>
      <p className='text-primary'>Far far away, behind the word mountains, far from the countries Vokalia <br /> and Consonantia, there live the blind texts.</p>
