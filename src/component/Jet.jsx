...
const Jet = () => {
  return (
    <div className="bg-white sm:w-[79rem]  w-[100%] sm:h-[40rem]  h-[44rem] mt-[100px] sm:mt-[0px] rounded-xl shadow-xl p-4 flex flex-col sm:flex sm:flex-row justify-between items-center">
      <Sidebar />
